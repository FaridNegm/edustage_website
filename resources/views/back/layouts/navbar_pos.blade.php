        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box" style="padding: 0px 5px;">
                <a href="index.html" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ url('back') }}/assets/images/orange_small.png" alt="" height="70" >
                    </span>
                    <span class="logo-lg">
                        <img src="{{ url('back') }}/assets/images/orange.png" alt="" height="55" >
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ url('back') }}/assets/images/users/avatar-1.jpg" alt="Header Avatar">
