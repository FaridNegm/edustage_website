										...
										<div class="bg-primary bg-soft">
											<div class="row">
												...
												<div class="col-5 align-self-end">
													<img src="{{ url('back') }}/="{{ url('back') }}/="assets/images/profile-img.png" alt="" class="img-fluid">
												</div>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-sm-4">
													<div class="avatar-md profile-user-wid mb-4">
														<img src="{{ url('back') }}/="{{ url('back') }}/="assets/images/users/avatar-1.jpg" alt="" class="img-thumbnail rounded-circle">
													</div>
										...
										<table class="table align-middle table-nowrap">
											...
											<tbody>
												<tr>
													<th scope="row">
														<div>
															<img src="{{ url('back') }}/="{{ url('back') }}/="assets/images/product/img-7.png" alt="" class="avatar-sm">
														</div>
													</th>
													<td>
														<div>
												...
												<tr>
													<th scope="row">
														<div>
															<img src="{{ url('back') }}/="{{ url('back') }}/="assets/images/product/img-4.png" alt="" class="avatar-sm">
														</div>
													</th>
													<td>
														<div>
