...
@section('title')
     ( {{ $find['class_room_name'] }} )تعديل باقات الإشتراكات 
@endsection
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">                                            
                                            <div class="col-md-6">
                                                ...
                                                <input id="one_mat_counter_heading" name="one_mat_counter_heading" type="text" class="form-control" placeholder="وصف ما قبل مدة الباقة" value="{{ old('one_mat_counter_heading', $find['one_mat_counter_heading']) }}">
                                            </div>
